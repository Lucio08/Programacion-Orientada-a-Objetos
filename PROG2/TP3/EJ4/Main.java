...
public class Main {
    public static void main(String[] args) {
        ...
        miCelular.agregarNuevoContacto(c1);
        miCelular.agregarNuevoContacto(c2);
        miCelular.agregarNuevoContacto(c3);
        miCelular.agregarNuevoContacto(c4);
        miCelular.agregarNuevoContacto(c5);

        // Mostrar promedio de edad
        double promedioEdad = miCelular.promedioEdad();
        ...
        for (Contacto c : repetidos) {
            System.out.println(c.getNombre() + " " + c.getApellido() + " - Tel: " + c.getNumero());
        }
